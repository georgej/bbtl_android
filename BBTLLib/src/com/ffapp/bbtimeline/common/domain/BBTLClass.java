 ...
 *
 */
public class BBTLClass extends BBTLBaseBean implements Serializable{
	
	/** 
	* @Fields serialVersionUID : TODO(用一句话描述这个变量表示什么) 
	*/ 
	private static final long serialVersionUID = -1758531379507545190L;
