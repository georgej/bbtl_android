package com.ffapp.bbtimeline.common.framework.config;
...
import com.ffapp.bbtimeline.common.framework.constants.Constants;
...
public final class AppConfig {
	...
	private static AppInfo parse(InputStream is) throws Exception {
		...
		//appInfo.serverAddress = appConfig.getString("server_address");//本地
		appInfo.serverAddress = appConfig.getString("server_address1");
