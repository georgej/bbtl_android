...
public class CityUtil {
	...
	private Map<String, String> allNameIDMap;
	...
	private void initMap() {
		allNameIDMap = new HashMap<String, String>();
		...
		for (int i = 0; i < allNames.length; i++) {
			allNameIDMap.put(allNames[i], allIDs[i]);
		}
	}
	...
	public String[] getProvinces(){
		return new String[] {"北京","黑龙江省", "吉林省", "辽宁省", "内蒙古自治区", "河北省", "山西省", "陕西省",  
	            "山东省", "新疆新疆维吾尔自治区 ", "西藏自治区", "青海省", "甘肃省", "宁夏回族自治区", "河南省", "江苏省", "湖北省", "浙江省",  
	            "安徽省", "福建省", "江西省", "湖南省", "贵州省", "四川省", "广东省", "云南省", "广西壮族自治区", "海南省",  
	            "台湾省","其他直辖市"};  
	}
	/**
	 * 获取全部的城市
	...
	public String[][] getCitys(){
		return new String[][] { 
			{"东城区","西城区","崇文区","宣武区","朝阳区","海淀区","丰台区","石景山区","房山区","通州区","顺义区",
				"大兴区","昌平区","平谷区","怀柔区","门头沟区","密云县","延庆县"},	
