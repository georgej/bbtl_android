...
public class DBHelper extends SQLiteOpenHelper {
	...
	private void initDB(SQLiteDatabase db) {
		...
		// *username 用户名
		// *password 密码（MD5加密）
		// *用户购课类型 0未购课 1已购课 2未选课
		// */
		// String sql =
		// "create table user(uid int primary key autoincrement,user_id " +
		// ",username varchar(40),password varchar(100),cwtype int)";
		//
		// /*
		// * exam
		// */
		// sql =
		// "create table exam(uid int primary key autoincrement,exam_id int,name varchar(100),user_id int)";
		//
		// /*
		// * subject 科目
		// * name 名称
		...
		// * row 行号
		// */
		// sql = "create table subject(uid int primary key autoincrement," +
		// "subject_id int,name varchar(100),year int,exam_id int,row int)";
		//
		//
		// /*
		// * course 课程
		...
		// * row 行号
		// */
		// sql = "create table course(uid int primary key autoincrement," +
		// "course_id int,name varchar(100),chapter varchar(100)," +
		// "progress varchar(100),updateDate varchar(20),subject_id in,row int)";
		//
		//
		// /* section 章节
		// * row 行号
		...
		// */
		// String sql =
		// "create table section(uid integer primary key autoincrement,row int,name varchar(100),"
		// +
		// "desc varchar(100),exam_id int,subject_id int,course_id int,user_id int)";
		// db.execSQL(sql);
		//
		// /*
		// * courseware 课件
		...
		// */
		// sql =
		// "create table courseware(uid integer primary key autoincrement,row int,courseware_id,"
		// +
		// "name varchar(100),chapter varchar(100),url varchar(100)" +
		// ",section_id int)";
		// db.execSQL(sql);
		/*
